...
const QuickStats = () => {
  ...
  return (
    <div className='flex flex-col gap-3 rounded-md border-[0.004px]
     border-gray-300 py-[20px] px-[15px]'>
      ...
      <div className='flex gap-[20px]'>
        {quickStatistics.map((item,index) => {
          ...
          return(
              <div key={index} className='flex gap-2 border-r-[0.004px]
               border-r-gray-300 p-[5px] justify-center items-center pr-[20px] ml-[10px]'>
                <div className={` flex p-[14px] bg-gray-100 rounded-full
                   border-gray-300 border-[0.004px] ${item.color}`}>
